...
func batchValidate() ([]string, error) {
	fail := []string{}
	file, err := os.OpenFile("./batch.txt", os.O_RDWR, 0666)
	if err != nil {
	...
	fileObj, err := os.OpenFile("./result.txt", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0644)
	if err != nil {
